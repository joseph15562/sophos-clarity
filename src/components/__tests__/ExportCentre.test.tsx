...
const branding = { customerName: "Acme", selectedFrameworks: [] as string[] };
...
describe("ExportCentre", () => {
  ...
  it("disables buttons when no results", () => {
    renderWithProviders(<ExportCentre analysisResults={{}} branding={branding} />);
