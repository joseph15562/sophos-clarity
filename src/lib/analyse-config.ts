 ...
 *
 * This file is a thin orchestrator. Domain analysis logic lives in
 * src/lib/analysis/domains/*.ts; shared helpers in analysis/helpers.ts,
 * analysis/rule-predicates.ts, analysis/section-meta.ts, and
 * analysis/ssl-tls-inspection.ts.
 */
...
// Re-export public types for backward compatibility (30+ consumers import from here)
export type {
  Severity,
  ConfigStats,
  SslTlsRule,
