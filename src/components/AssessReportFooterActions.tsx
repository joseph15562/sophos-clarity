...
export type AssessReportFooterActionsProps = {
...
/** View Findings + Generate Reports for the global Assess footer (with missing-context dialog). */
export function AssessReportFooterActions({
  branding,
  onScrollToFindings,
  onScrollToReports,
  onScrollToContext,
  onGenerateAll,
}: AssessReportFooterActionsProps) {
