                        ...
                        {ctrl ? (
                          <Tooltip delayDuration={150}>
                            <TooltipTrigger asChild>
                              <span
                                className={cn(
                                  "inline-flex items-center justify-center h-6 w-6 rounded-md text-[13px] font-black outline-none",
                                  hasFindings ? "cursor-pointer" : "cursor-help",
                                )}
                            ...
                            <TooltipContent
                              ...
                              className={cn(
                                ...
                                "z-[100] max-w-[280px] border-border p-3 text-left text-xs shadow-lg",
                              )}
                            >
                              <p className="text-[10px] font-bold uppercase tracking-wide text-muted-foreground">
                                {m.framework}
                              </p>
                              <p className="mt-1 font-bold text-foreground">{ctrl.controlName}</p>
                              <p className="mt-1 text-[10px] leading-relaxed text-muted-foreground">
                                {ctrl.evidence || "No evidence gathered"}
                              </p>
                              <p className="mt-2">
                                <span
                                  className="inline-flex items-center gap-1.5 rounded-md border px-2 py-0.5 text-[9px] font-black"
                                  style={{
                                    color: STATUS_HEX[status],
                                    backgroundColor: `${STATUS_HEX[status]}14`,
                                    borderColor: `${STATUS_HEX[status]}22`,
                                  }}
                                >
                                  {s.icon} {s.label}
                                </span>
                          ...
                          <span
                            title="Not mapped for this framework in this export"
                            className="inline-flex h-6 w-6 cursor-default items-center justify-center rounded-md text-[13px] font-black"
                            style={{ color: STATUS_HEX[status] }}
                          >
                            {s.icon}
                          </span>
