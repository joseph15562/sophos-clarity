...
export const WIDGET_REGISTRY: WidgetDef[] = [
  ...
  {
    id: "protocol-service-usage",
    label: "Protocol & Service Usage",
    tab: "security",
    isDefault: false,
  },
  ...
  // ── Compliance ──
  {
    ...
    label: "Compliance Summary (Posture & Coverage)",
    tab: "compliance",
    isDefault: false,
  },
  {
    id: "compliance-gaps",
    label: "Compliance Gaps & Control Map",
    tab: "compliance",
    isDefault: false,
  },
  ...
  // ── Optimisation ──
  {
    ...
    label: "Config & Policy Complexity",
    tab: "optimisation",
    isDefault: false,
  },
  ...
  {
    id: "rule-analysis",
    label: "Rule Consolidation & Overlap",
    tab: "optimisation",
    isDefault: false,
  },
  ...
  {
    id: "fix-effort-breakdown",
    label: "Fix Effort Breakdown",
    tab: "remediation",
    isDefault: false,
  },
  {
    id: "impact-effort-bubble",
    label: "Impact vs Effort Bubble",
    tab: "remediation",
    isDefault: false,
  },
];
