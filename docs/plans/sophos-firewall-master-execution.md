...
| ID   | Anchors                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| G3.1 | **Partner Cloud:** [ConnectWiseCloudSettings.tsx](../src/components/ConnectWiseCloudSettings.tsx), [connectwise.ts](../supabase/functions/api/routes/connectwise.ts), [\_shared/connectwise-cloud.ts](../supabase/functions/_shared/connectwise-cloud.ts). **Manage:** [ConnectWiseManageSettings.tsx](../src/components/ConnectWiseManageSettings.tsx), [ConnectWiseTicketFromFindingDialog.tsx](../src/components/ConnectWiseTicketFromFindingDialog.tsx), [connectwise-manage.ts](../supabase/functions/api/routes/connectwise-manage.ts). **Autotask PSA:** [AutotaskPsaSettings.tsx](../src/components/AutotaskPsaSettings.tsx), [AutotaskTicketFromFindingDialog.tsx](../src/components/AutotaskTicketFromFindingDialog.tsx), [\_shared/autotask-psa.ts](../supabase/functions/_shared/autotask-psa.ts), [autotask-psa.ts](../supabase/functions/api/routes/autotask-psa.ts), migration `20260329240000_autotask_psa_credentials.sql`. **Shared:** [FirecomplyCustomerMappingInput.tsx](../src/components/psa/FirecomplyCustomerMappingInput.tsx), [FindingsBulkView.tsx](../src/components/FindingsBulkView.tsx), [Index.tsx](../src/pages/Index.tsx) → [AnalysisTabs](../src/components/AnalysisTabs.tsx) customer key, `20260329220000_psa_customer_company_map.sql`. |
...
1. **G3.1** — Optional **auto-ticket** when an assessment completes; **Halo** (or third PSA) pattern; optional **customer mapping** UI on Customers page.
...
_Updated: 2026-03-29 — Autotask PSA MVP; shared FireComply customer mapping control; next: auto-ticket + more scopes._
