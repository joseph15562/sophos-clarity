    ...
    <div className="rounded-2xl border border-slate-900/[0.10] dark:border-white/[0.06] bg-card px-4 py-3 space-y-3">
      <div className="flex flex-wrap items-center gap-2 text-sm font-medium">
        ...
        <span className="text-[11px] text-muted-foreground font-normal w-full sm:w-auto sm:flex-1">
          Toggle when you have verified on the appliance — MDR threat feeds and NDR Essentials are
          often omitted from HTML/XML exports. This scores those best-practice rows as pass without
          using per-check manual overrides.
        </span>
      </div>
  ...
  return (
    <div className="rounded-2xl border border-slate-900/[0.10] dark:border-white/[0.06] bg-card px-4 py-3 space-y-3">
      <div className="flex flex-wrap items-center gap-2 text-sm font-medium">
        ...
        <span className="text-[11px] text-muted-foreground font-normal w-full sm:w-auto sm:flex-1">
          DNS Protection configuration is not included in HTML/XML exports. Toggle when you have
          verified that Sophos DNS Protection IPs are configured as the firewall's upstream DNS
          servers.
        </span>
      </div>
      <div className="flex items-center justify-between gap-4 sm:justify-start sm:gap-3">
